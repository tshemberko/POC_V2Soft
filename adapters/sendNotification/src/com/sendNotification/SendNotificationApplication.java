...
public class SendNotificationApplication extends MFPJAXRSApplication{

	static Logger logger = Logger.getLogger(SendNotificationApplication.class.getName());
	
	@Override
	protected void init() throws Exception {
		SendNotificationResource.init();
